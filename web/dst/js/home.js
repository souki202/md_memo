...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _getApiUrl_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getApiUrl.js */ \"./web/src/js/getApiUrl.js\");\n/* harmony import */ var _colorTheme_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./colorTheme.js */ \"./web/src/js/colorTheme.js\");\n/* harmony import */ var _urlParameter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./urlParameter.js */ \"./web/src/js/urlParameter.js\");\n/* harmony import */ var _memoListItemComponent_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./memoListItemComponent.js */ \"./web/src/js/memoListItemComponent.js\");\n/* harmony import */ var _js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js.cookie.min.js */ \"./web/src/js/js.cookie.min.js\");\n/* harmony import */ var _js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4__);\n\n\n\n\n\naxios.defaults.withCredentials = true;\nconst Loading = window.VueLoading;\nVue.component('memo-card', _memoListItemComponent_js__WEBPACK_IMPORTED_MODULE_3__.default);\nnew Vue({\n  el: '#homeMemoList',\n  components: {\n    'loading': Loading\n  },\n  data: () => {\n    return {\n      errorMessage: '',\n      memos: [],\n      pinnedMemos: [],\n      nextPageMemoId: '',\n      memoAllCheck: false,\n      isTrash: false,\n      operationType: '',\n      theme: 'light',\n      // loading\n      isLoading: false,\n      fullPage: true\n    };\n  },\n\n  mounted() {\n    const place = (0,_urlParameter_js__WEBPACK_IMPORTED_MODULE_2__.default)('place');\n\n    if (place == 'trash') {\n      this.isTrash = true;\n      this.getTrashMemoList();\n    } else {\n      this.getMemoList();\n      this.getPinnedMemoList();\n    } // tableのカラーを設定\n\n\n    this.theme = (0,_colorTheme_js__WEBPACK_IMPORTED_MODULE_1__.default)();\n  },\n\n  methods: {\n    clearMessage() {\n      this.errorMessage = '';\n    },\n\n    switchAllCheck() {\n      for (const i in this.memos) {\n        this.$set(this.memos[i], 'checked', this.memoAllCheck);\n      }\n    },\n\n    getMemoList() {\n      axios.get((0,_getApiUrl_js__WEBPACK_IMPORTED_MODULE_0__.default)() + '/get_memo_list').then(res => {\n        console.log(res);\n\n        for (let item of res.data.items) {\n          item.checked = false;\n          this.memos.push(item);\n        }\n\n        this.nextPageMemoId = res.data.next_page_memo_id;\n      }).catch(err => {\n        console.log(err);\n        this.errorMessage = 'メモ一覧の取得に失敗しました';\n      }).then(() => {});\n    },\n\n    getTrashMemoList() {\n      axios.get((0,_getApiUrl_js__WEBPACK_IMPORTED_MODULE_0__.default)() + '/get_trash_memo_list').then(res => {\n        for (let item of res.data.items) {\n          item.checked = false;\n          this.memos.push(item);\n        }\n\n        this.nextPageMemoId = res.data.next_page_memo_id;\n      }).catch(err => {\n        console.log(err);\n        this.errorMessage = 'メモ一覧の取得に失敗しました';\n      }).then(() => {});\n    },\n\n    addMemoList() {\n      if (this.nextPageMemoId) {\n        const params = {\n          next_page_memo_id: this.nextPageMemoId\n        };\n        axios.get((0,_getApiUrl_js__WEBPACK_IMPORTED_MODULE_0__.default)() + '/get_memo_list', {\n          params: params\n        }).then(res => {\n          for (let item of res.data.items) {\n            item.checked = false;\n            this.memos.push(item);\n          }\n\n          this.nextPageMemoId = res.data.next_page_memo_id;\n        }).catch(err => {\n          console.log(err);\n          this.errorMessage = 'メモ一覧の取得に失敗しました';\n        }).then(() => {});\n      }\n    },\n\n    getPinnedMemoList() {\n      axios.get((0,_getApiUrl_js__WEBPACK_IMPORTED_MODULE_0__.default)() + '/get_pinned_memo_list').then(res => {\n        console.log(res);\n\n        for (let item of res.data.items) {\n          item.checked = false;\n          this.pinnedMemos.push(item);\n        }\n      }).catch(err => {\n        console.log(err);\n        this.errorMessage = 'Failed to get the memo list.';\n      }).then(() => {});\n    },\n\n    /**\r\n     * @returns {Array<string>} チェックされたメモのuuid一覧\r\n     */\n    getCheckMemoList() {\n      let result = [];\n      this.memos.forEach(e => {\n        if (e.checked) result.push(e.uuid);\n      });\n      this.pinnedMemos.forEach(e => {\n        if (e.checked) result.push(e.uuid);\n      }); // 重複消去\n\n      result.filter(function (x, i, self) {\n        return self.indexOf(x) === i;\n      });\n      return result;\n    },\n\n    toTrashMemo(checkedMemoList) {\n      // if (!window.confirm('ゴミ箱に移動するとシェアの設定が削除されます. よろしいですか?')) {\n      //     return;\n      // }\n      axios.post((0,_getApiUrl_js__WEBPACK_IMPORTED_MODULE_0__.default)() + '/to_trash_memo', {\n        params: {\n          memo_id_list: checkedMemoList\n        }\n      }).then(res => {\n        console.log(res);\n        location.reload();\n      }).catch(err => {\n        console.log(err);\n        this.errorMessage = 'メモの削除に失敗しました';\n      }).then(() => {\n        this.isLoading = false;\n      });\n    },\n\n    /**\r\n     * メモのソフトデリートを実行する\r\n     */\n    deleteMemo(checkedMemoList) {\n      if (!window.confirm('ゴミ箱から削除したメモは復元できません。削除してよろしいですか?')) {\n        return;\n      }\n\n      axios.post((0,_getApiUrl_js__WEBPACK_IMPORTED_MODULE_0__.default)() + '/delete_memo', {\n        params: {\n          memo_id_list: checkedMemoList\n        }\n      }).then(res => {\n        console.log(res);\n        location.reload();\n      }).catch(err => {\n        console.log(err);\n        this.errorMessage = 'メモの削除に失敗しました';\n      }).then(() => {\n        this.isLoading = false;\n      });\n    },\n\n    /**\r\n     * メモをゴミ箱から戻す\r\n     */\n    restoreMemo(checkedMemoList) {\n      axios.post((0,_getApiUrl_js__WEBPACK_IMPORTED_MODULE_0__.default)() + '/restore_memo', {\n        params: {\n          memo_id_list: checkedMemoList\n        }\n      }).then(res => {\n        console.log(res);\n        location.reload();\n      }).catch(err => {\n        console.log(err);\n        this.errorMessage = 'メモの削除に失敗しました';\n      }).then(() => {\n        this.isLoading = false;\n      });\n    },\n\n    memoOperation() {\n      this.clearMessage();\n      const checkedMemoList = this.getCheckMemoList();\n\n      if (!checkedMemoList.length) {\n        window.alert('メモが選択されていません');\n        return;\n      }\n\n      if (checkedMemoList.length > 10) {\n        window.alert('10件より多くの選択はできません');\n        return;\n      }\n\n      this.isLoading = true;\n\n      switch (this.operationType) {\n        case 'trash':\n          this.toTrashMemo(checkedMemoList);\n          break;\n\n        case 'delete':\n          this.deleteMemo(checkedMemoList);\n          break;\n\n        case 'restore':\n          this.restoreMemo(checkedMemoList);\n          break;\n      }\n\n      this.operationType = '';\n    },\n\n    truncateTrash() {\n      this.clearMessage();\n\n      if (!window.confirm('ゴミ箱から削除したメモは復元できません。削除してよろしいですか?\\nなお、件数次第で削除に時間がかかる場合があります。')) {\n        return;\n      }\n\n      this.isLoading = true;\n      axios.post((0,_getApiUrl_js__WEBPACK_IMPORTED_MODULE_0__.default)() + '/truncate_trash_memo').then(res => {\n        console.log(res);\n        location.reload();\n      }).catch(err => {\n        console.log(err);\n        this.errorMessage = 'メモの削除に失敗しました';\n      }).then(() => {\n        this.isLoading = false;\n      });\n    }\n\n  }\n});\n\n//# sourceURL=webpack://web/./web/src/js/home.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./web/src/js/home.js");
/******/ 	
/******/ })()
;