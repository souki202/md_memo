...
call sam deploy --template-file template-output.yaml --stack-name md-memo-prod --parameter-overrides Env=dev --capabilities CAPABILITY_IAM CAPABILITY_AUTO_EXPAND
cd ..
